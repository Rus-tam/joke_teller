...
const tellMe = (joke) => {
    ...
    VoiceRSS.speech({
    key: '3a6eb0afe1404a959efc9b9f30189e27',
    src: joke,
    hl: 'en-us',
    r: 0,
    c: 'mp3',
...
async function getJokes() {
    const apiURL = 'https://sv443.net/jokeapi/v2/joke/Programming,Miscellaneous,Dark,Pun,Spooky,Christmas?blacklistFlags=nsfw,religious,racist&type=single'
    //const apiURL = 'https://rzhunemogu.ru/RandJSON.aspx?CType=4'
    let joke = ''
    try {
